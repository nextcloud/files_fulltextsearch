...
namespace OCA\Files_FullTextSearch\Tools\Traits;

use Exception;
use JsonSerializable;
use OCA\Files_FullTextSearch\Tools\Exceptions\ArrayNotFoundException;
use OCA\Files_FullTextSearch\Tools\Exceptions\ItemNotFoundException;
use OCA\Files_FullTextSearch\Tools\Exceptions\MalformedArrayException;
use OCA\Files_FullTextSearch\Tools\Exceptions\UnknownTypeException;
