OC.L10N.register(
    ...
    "Local files" : "Kohalikud kaustad",
    "Within external files" : "Väliste failide seast",
    "External files" : "Välised failid",
    "Within group folders" : "Grupikaustade seast",
    "Group folders" : "Grupikaustad",
    "Filter by extension" : "Filtreeri laiendi alusel",
    "Extension" : "Laiend",
    ...
    "Maximum file size to index (in Mb)." : "Indekseeritavate failise suuruse ülempiir (Mb).",
    "Extract PDF" : "Eralda PDF-failide sisu",
    "Index the content of PDF files." : "Indekseeri PDF-failidest eraldatud sisu.",
    "Extract Office" : "Eralda kontroritarkvarafailide sisu",
