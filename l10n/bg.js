OC.L10N.register(
    ...
    "Files" : "Файлове",
    "Within current directory" : "В рамките на текущата директория",
    "Within local files" : "В рамките на локални файлове",
    "Local files" : "Локални файлове",
    "Within external files" : "В рамките на външните файлове",
    "External files" : "Външни файлове",
    "Within group folders" : "В рамките на груповите папки",
    "Group folders" : "Споделени папки",
    "Filter by extension" : "Филтриране по разширение",
    ...
    "Maximum file size to index (in Mb)." : "Максимален размер на индекс (в Mb).",
