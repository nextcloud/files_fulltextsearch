OC.L10N.register(
    ...
    "Within external files" : "Ndani ya faili za nje",
    "External files" : "Faili za nje",
    "Within group folders" : "Ndani ya folda za kundi",
    "Group folders" : "Folda za kundi",
    "Filter by extension" : "Chuja kwa kiendelezi",
    "Extension" : "Upanuaji",
    ...
    "Maximum file size to index (in Mb)." : "Kiwango cha juu cha ukubwa wa faili hadi faharasa (katika Mb).",
    "Extract PDF" : "Zindua PDF",
    "Index the content of PDF files." : "Fahirisha yaliyomo kwenye faili za PDF.",
    "Extract Office" : "Zindua",
