OC.L10N.register(
    ...
    "Within external files" : "外部ファイル内",
    "External files" : "外部ファイル",
    "Within group folders" : "グループフォルダ内",
    "Group folders" : "グループフォルダー",
    "Filter by extension" : "拡張子でフィルタリングする",
    "Extension" : "拡張",
    ...
    "Group Folders" : "グループフォルダー",
    "Index the content of group folders." : "グループフォルダのコンテンツのインデックスを作成します。",
    "Types" : "タイプ",
    "Maximum file size" : "最大ファイルサイズ",
    "Maximum file size to index (in Mb)." : "インデックスを作成する最大ファイルサイズ（MB単位）。",
