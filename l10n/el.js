OC.L10N.register(
    ...
    "Within external files" : "Στα εξωτερικά αρχεία",
    "External files" : "Εξωτερικά αρχεία",
    "Within group folders" : "Στους φακέλους ομάδας",
    "Group folders" : "Ομαδικοί φάκελοι",
    "Filter by extension" : "Φίλτρο ανά επέκταση",
    "Extension" : "Επέκταση",
    ...
    "Maximum file size to index (in Mb)." : "Μέγιστο μέγεθος ευρετηρίου (σε Mb).",
