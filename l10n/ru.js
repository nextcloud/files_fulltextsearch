OC.L10N.register(
    ...
    "Files" : "Файлы",
    "Sources" : "Источник",
    "Index the content of local files." : "Индексировать контент локальных файлах",
    "Group Folders" : "Групповые папки",
    "Index the content of group folders." : "Индексировать контент групповых папок",
    "Maximum file size" : "Максимальный размер файла",
    "Maximum file size to index (in Mb)." : "Максимальный размер файла для индекса (в Мб)"
},
