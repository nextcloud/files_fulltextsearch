OC.L10N.register(
    ...
    "Within external files" : "Dalam file eksternal",
    "External files" : "File eksternal",
    "Within group folders" : "Dalam folder grup",
    "Group folders" : "Folder grup",
    "Filter by extension" : "Filter berdasarkan ekstensi",
    "Extension" : "Ekstensi",
    ...
    "Maximum file size to index (in Mb)." : "Ukuran file maksimum untuk diindeks (dalam Mb).",
    "Extract PDF" : "Ekstrak PDF",
    "Index the content of PDF files." : "Indeks konten file PDF.",
    "Extract Office" : "Ekstrak Office",
