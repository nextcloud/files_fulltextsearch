OC.L10N.register(
    ...
    "Within external files" : "Laistigh de chomhaid sheachtracha",
    "External files" : "Comhaid sheachtracha",
    "Within group folders" : "Laistigh de fhillteáin ghrúpa",
    "Group folders" : "Fillteáin ghrúpa",
    "Filter by extension" : "Scag le síneadh",
    "Extension" : "Síneadh",
    ...
    "Maximum file size to index (in Mb)." : "Uasmhéid comhaid le hinnéacsú (i Mb).",
    "Extract PDF" : "PDF sliocht",
    "Index the content of PDF files." : "Innéacs ábhar comhaid PDF.",
    "Extract Office" : "Oifig Sliocht",
