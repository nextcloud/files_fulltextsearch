OC.L10N.register(
    ...
    "Within external files" : "درون پرونده‌های خارجی",
    "External files" : "پرونده‌های خارجی",
    "Within group folders" : "درون پوشه‌های گروهی",
    "Group folders" : "پوشه‌های گروهی",
    "Filter by extension" : "فیلتر بر اساس پسوند",
    "Extension" : "پسوند",
    ...
    "Maximum file size to index (in Mb)." : "حداکثر اندازه پرونده برای نمایه‌سازی (بر حسب مگابایت).",
    "Extract PDF" : "استخراج PDF",
    "Index the content of PDF files." : "نمایه‌سازی محتوای پرونده‌های PDF.",
    "Extract Office" : "استخراج آفیس",
